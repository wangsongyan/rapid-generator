...
public class StringHelper {
   ...
   public static String defaultString(Object value) {
    ...
    public static String removeTableSqlNamePrefix(String sqlName) {
        return removeSqlNamePrefix(sqlName, GeneratorConstants.TABLE_REMOVE_PREFIXES);
    }
     ...
     * @return
     */
    public static String removeColumnSqlNamePrefix(String sqlName) {
    	return removeSqlNamePrefix(sqlName, GeneratorConstants.COLUMN_REMOVE_PREFIXES);
    }
     ...
     * @return
     */
    public static String removeSqlNamePrefix(String sqlName,GeneratorConstants key){
        String[] prefixs = GeneratorProperties.getStringArray(key);
        for(String prefix : prefixs) {
            String removedPrefixSqlName = StringHelper.removePrefix(sqlName, prefix,true);
            if(isEmpty(removedPrefixSqlName)){
            	//如果处理完之后，字段为空。忽视此次处理
            }else if(!removedPrefixSqlName.equals(sqlName)) {
