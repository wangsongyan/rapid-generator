...
public class DataSourceProvider {
	...
	public static class DriverManagerDataSource implements DataSource {
		...
		public Connection getConnection() throws SQLException {
			...
			properties.put("remarks", "true"); //设置可以获取remarks信息 
			properties.put("useInformationSchema","true");
			return DriverManager.getConnection(getUrl(),/*getUsername(), getPassword()*/properties);
		}
		...
		public Connection getConnection(String username, String password) throws SQLException {
			...
			return DriverManager.getConnection(getUrl(),/*username, password*/properties);
		}
